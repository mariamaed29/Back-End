...
<body>
    ...
    <select name="categoria" required>
        ...
        <option value="Refrigerante">Romance</option>
        <option value="Cerveja">Fantasia</option>
        <option value="Vinho">Ficção Científica</option>
        <option value="Destilado">Terror</option>
        <option value="Água">Suspense</option>
        <option value="Suco">Drama</option>
        <option value="Energético">Comédia</option>
</select>
            ...
            <tr>
                ...
                <td>
                    <form method="POST" class="form-acao" style="display: inline;">
                        ...
                        <input type="hidden" name="nome" value="<?php echo htmlspecialchars($livro->getId()); ?>">
